...
namespace Kelechek_otchet_dlya_nachalnikov.Controllers
{
    ...
    [ApiController]
    public class TsehRozlivaFirstController : ControllerBase
    {
        private readonly Kelechek_otchet_dlya_nachalnikovContext _context;

        public TsehRozlivaFirstController(Kelechek_otchet_dlya_nachalnikovContext context)
        {
            _context = context;
        }
        ...
        {            
            int responsibleAreaId = _context.ResponsibleAreas.Where(n => n.name.Equals("ЦЕХ розлива №1")).FirstOrDefault().id;
